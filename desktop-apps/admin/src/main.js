...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    icon: path.join(__dirname, 'public/admin-icon.png'),
  });

  // Load app - direct to admin dashboard
  const startUrl = isDev
    ? 'http://localhost:3000/admin'  // Dev: Direct to admin route
    : `file://${path.join(__dirname, '../../../citi-nati-frontend/dist/index.html?app=admin')}`; // Prod: Load with app param
...
/**
 * IPC Handlers - reuse from shared constants
 */
