...
const AdminSales = () => {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        <div className="admin-tabs-strip" style={{ marginBottom: 0 }}>
          ...
          <div style={{ marginLeft: 'auto', fontSize: '0.85rem', color: currentSalesDay ? '#2D8659' : '#dc3545', fontWeight: '700', whiteSpace: 'nowrap' }}>
