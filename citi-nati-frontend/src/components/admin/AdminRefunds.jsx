  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: '#5B4B8A', marginBottom: '0.5rem' }}>💰 Pending Refunds</h2>
          ...
          {refunds.map((refund) => (
            ...
            >
              ...
              <div style={{ marginBottom: '1rem' }}>
                <h4 style={{ margin: '0 0 0.5rem 0', color: '#5B4B8A' }}>📦 Items:</h4>
              ...
              {/* Refund Reason */}
              <div style={{ marginBottom: '1rem' }}>
                <h4 style={{ margin: '0 0 0.5rem 0', color: '#5B4B8A' }}>⚠️ Reason:</h4>
                <p style={{
                  margin: 0,
                  padding: '0.75rem',
                  backgroundColor: '#f8f9fa',
