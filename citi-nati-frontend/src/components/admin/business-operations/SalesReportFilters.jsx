...
const SalesReportFilters = ({
  ...
  const handleCodeChange = (key) => (event) => {
    onChange(key, normalizeCode(event.target.value));
  };
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
        <div>
          ...
          <p style={{ margin: '0.35rem 0 0', color: '#64748b', fontSize: '0.92rem' }}>
            Change the reporting period and branch/location filters. Reports use Branch Code + Location Code as the true scope.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: '0.85rem' }}>
        ...
        <Field label="Branch Code">
          <input
            ...
            onChange={handleCodeChange('branchCode')}
        ...
        <Field label="Location Code">
          <input
            ...
            onChange={handleCodeChange('locationCode')}
            placeholder="Any location code"
            style={FIELD_STYLE}
          />
        </Field>
        ...
        <Field label="Sync Source">
          <input
            value={filters.syncSourceCode || ''}
            onChange={handleCodeChange('syncSourceCode')}
        ...
        <Field label="Product Code">
          <input
            ...
            onChange={handleCodeChange('productCode')}
      ...
      <div style={{ marginTop: '1rem', display: 'flex', gap: '0.75rem', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        >
          {resolvedRange?.startDate && resolvedRange?.endDate
            ? `${resolvedRange.startDate} to ${resolvedRange.endDate}`
