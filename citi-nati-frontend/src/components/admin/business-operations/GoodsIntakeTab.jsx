  ...
  return (
    <div style={{ display: 'grid', gap: '1rem', width: '100%', minWidth: 0, fontSize: '0.92rem' }}>
                  ...
                  <thead>
                    <tr>
                      {['Ref', 'Date', 'Supplier', 'Location', 'Intake Status', 'POS Transfer', 'Items', 'Total Cost', 'Actions'].map((label) => (
                        <th key={label} style={{ textAlign: 'left', padding: '0.48rem 0.4rem', fontSize: '0.72rem', color: colors.mutedText, borderBottom: `1px solid ${isAdminDarkTheme ? '#334155' : '#e2e8f0'}` }}>{label}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
      ...
      {isTransferHistoryOpen && canViewHistory && (
        <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(15, 23, 42, 0.45)', zIndex: 173, display: 'grid', placeItems: 'center', padding: isTransferHistoryMaximized ? '0.35rem' : '1rem' }}>
      ...
      {isPriceSyncHistoryOpen && canViewHistory && (
        <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(15, 23, 42, 0.45)', zIndex: 174, display: 'grid', placeItems: 'center', padding: isPriceSyncHistoryMaximized ? '0.35rem' : '1rem' }}>
