...
const AdminBusinessOperations = ({ selectedLocationCode, selectedBranchCode }) => {
  ...
  const selectedLocation = useMemo(() => {
    if (!selectedLocationCode || !selectedBranchCode) {
      return null;
    }

    // Find matching scope from BO_OPERATIONAL_SCOPES
    return BO_OPERATIONAL_SCOPES.find((scope) =>
      scope.code === selectedLocationCode && scope.branchCode === selectedBranchCode
    ) || null;
  }, [selectedLocationCode, selectedBranchCode]);
  ...
  console.log('[BUSINESS OPS SCOPE]', {
    ...
    selectedLocationCodeValue,
    isAllLocationsSelected,
    selectedLocation: selectedLocation ? { code: selectedLocation.code, branchCode: selectedLocation.branchCode, name: selectedLocation.name } : null
  });
