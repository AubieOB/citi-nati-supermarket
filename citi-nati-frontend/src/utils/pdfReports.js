...
export const generateProductSalesReportPDF = (productSales, salesDays, dateRange = {}) => {
  ...
  groups.forEach((group, groupIndex) => {
    ...
    doc.text(`Product: ${group.productName}`, margin, y);
    y += 2;
    ...
    const bodyRows = group.rows.length > 0
      ? group.rows.map((row) => [
          ...
          row.discount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
          row.net.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
          row.vat.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
    ...
    y = (doc.lastAutoTable?.finalY || y + 8) + 2;
    ...
    autoTable(doc, {
      ...
      head: [],
      body: [[
        'Total for ' + group.productName,
        String(group.totalQty),
        group.totalDiscount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
        group.totalNet.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
        group.totalVat.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
  ...
  autoTable(doc, {
    ...
    body: [[
      ...
      grandTotals.discount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      grandTotals.net.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      grandTotals.vat.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
      grandTotals.gross.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
    ]],
    theme: 'grid',
    styles: {
      fontSize: 9,
