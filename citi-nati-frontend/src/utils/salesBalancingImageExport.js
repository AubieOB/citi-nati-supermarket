...
export async function exportSalesBalancingReportImage({
  ...
  logoImg.src = logo;
  logoImg.style.cssText = 'width: 410px; height: auto; object-fit: contain;';
  ...
  summarySection.innerHTML = `
    <div style="display: grid; gap: 8px; font-size: 20px;">
      ...
      <div style="display: flex; justify-content: space-between; padding-top: 8px; border-top: 1px solid ${BRAND.border}; color: ${resultColor(status)}; font-weight: bold; font-size: 22px;">
