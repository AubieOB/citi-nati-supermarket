...
export function exportStockMovementLedgerPdf({
  ...
  const dataTable = {
    ...
    columnStyles: {
      ...
      4: { cellWidth: 20, halign: 'left', overflow: 'ellipsize' },
      5: { cellWidth: 60, halign: 'left' },
      6: { cellWidth: 16, halign: 'right', overflow: 'ellipsize' },
      7: { cellWidth: 12, halign: 'right', overflow: 'ellipsize' },
      8: { cellWidth: 12, halign: 'right', overflow: 'ellipsize' },
      9: { cellWidth: 16, halign: 'right', overflow: 'ellipsize' },
      10: { cellWidth: 16, halign: 'right', overflow: 'ellipsize' },
      11: { cellWidth: 18, halign: 'right', overflow: 'ellipsize' },
      12: { cellWidth: 20, halign: 'right', overflow: 'ellipsize' },
    },
    didParseCell: (data) => {
