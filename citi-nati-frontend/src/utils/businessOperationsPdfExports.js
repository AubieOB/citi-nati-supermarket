...
export function exportStockMovementLedgerPdf({
  ...
  const dataTable = {
    ...
    rows,
    showHead: 'everyPage',
    styles: { overflow: 'linebreak', cellPadding: 2.2, fontSize: 7.2, valign: 'middle' },
    headStyles: {
      fillColor: toRgb(BRAND_PURPLE),
      textColor: [255, 255, 255],
      fontStyle: 'bold',
    ...
    columnStyles: {
      ...
      4: { cellWidth: 30, halign: 'left', overflow: 'ellipsize' },
      5: { cellWidth: 50, halign: 'left', overflow: 'linebreak' },
      6: { cellWidth: 12, halign: 'right', overflow: 'ellipsize' },
      ...
      11: { cellWidth: 22, halign: 'right', overflow: 'ellipsize' },
      12: { cellWidth: 26, halign: 'right', overflow: 'ellipsize' },
    },
    didParseCell: (data) => {
